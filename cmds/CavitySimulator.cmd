...
epicsEnvSet("STREAM_PROTOCOL_PATH", "/home/llrfuser/e3-trainings/siteApps/e3-CavitySimulator/CavitySimulator-loc/CavitySimulatorApp/Db")

drvAsynIPPortConfigure("$(PORT)", "10.1.3.229:7",0,0,0)

dbLoadRecords("iocAdminSoft.db", "IOC=$(USER):IocStats")
