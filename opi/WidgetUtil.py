...
def setItems(display, name, list):
	display.getWidget(name).setPropertyValue("items", list)
    
def setValue(display, name, list):
	display.getWidget(name).setPropertyValue("value", list)